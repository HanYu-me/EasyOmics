...
plot_fun=function(result,out,show_peakloci=T,color_manh=c("tomato","skyblue"),threshold=5e-8,corrected=T){
  ...
  chr_info[,2]= chr_info[,2]+sum(chr_info[,2])*0.02
  ...
  png(file=paste0(out,"manhattan.png"),width=10,height=6,units = "in",res=600)
  ...
  ###QQplot
  png(file=paste0(out,"qqplot.png"),width=6,height = 6,units="in",res=600)
  ...
  if(lambda$estimate>1.1 & corrected==T){
    ...
    png(file=paste0(out,"manhattan_corrected.png"),width=10,height=6,units = "in",res=600)
